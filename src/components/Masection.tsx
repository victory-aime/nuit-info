    ...
    return (
        ...
        >
            ...
            <Stack flex={{ base: '1', md: '1' }} align="flex-start" justify="center">
                ...
                <Text fontSize="lg" color="white" mb="4" fontFamily="Times New Roman, sans-serif" fontWeight="normal">
                    Les changements climatiques désignent les variations à long terme
                    de la température et des modèles météorologiques. Il peut s’agir
                    de variations naturelles, dues par exemple à celles du cycle solaire
                    ou à des éruptions volcaniques massives.
                </Text>
